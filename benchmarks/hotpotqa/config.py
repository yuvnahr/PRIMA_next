...
SEED = int(os.getenv("HOTPOTQA_SEED", "13"))
CONTEXT_SOURCES = {"distractor": "supplied_distractor_context", "fullwiki": "official_retrieved_context", "oracle": "oracle_gold_context"}
